...
-- Example webhook events that can be subscribed to:
...
-- DROP TRIGGER IF EXISTS trigger_auto_disable_failed_webhook ON webhooks;
-- DROP TRIGGER IF EXISTS trigger_webhooks_updated_at ON webhooks;
-- DROP FUNCTION IF EXISTS record_webhook_success(VARCHAR);
-- DROP FUNCTION IF EXISTS increment_webhook_failure(VARCHAR);
-- DROP FUNCTION IF EXISTS get_active_webhooks_for_event(VARCHAR, TEXT);
-- DROP FUNCTION IF EXISTS auto_disable_failed_webhook();
