...
exports.getBatchProcessingService = exports.BatchProcessingService = void 0;
...
class BatchProcessingService {
    constructor() {
        this.documentRepository = (0, DocumentRepository_1.getDocumentRepository)();
        this.mindsdbService = new MindsDBService_1.MindsDBService();
        this.cacheService = (0, CacheService_1.getCacheService)();
        this.auditRepository = (0, AuditLogRepository_1.getAuditLogRepository)();
     ...
     */
    async queueBatchEmbeddingUpdates(updates, options = {}) {
     ...
     */
    async performVectorIndexMaintenance(options) {
     ...
     */
    async bulkInsertDocuments(documents, generateEmbeddings = true) {
    ...
    async getOperationStatus(operationId) {
        ...
        const cachedOp = await this.cacheService.get(cacheKey);
     ...
     */
    async processEmbeddingUpdate(operation) {
     ...
     */
    async processVectorIndexRebuild(operation) {
     ...
     */
    async processBulkInsert(operation) {
        const cacheKey = `bulk_insert:${operation.id}`;
        const documents = await this.cacheService.get(cacheKey);
        if (!documents) {
     ...
     */
    async checkMaintenanceNeeded(options) {
     ...
     */
    groupUpdatesByMerchant(updates) {
     ...
     */
    generateOperationId(type, merchantId) {
...
let batchProcessingServiceInstance = null;
...
exports.getBatchProcessingService = getBatchProcessingService;
