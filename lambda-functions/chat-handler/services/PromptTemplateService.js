...
exports.getPromptTemplateService = exports.PromptTemplateService = void 0;
...
Keep responses concise and cite sources.`,
    ...
    async renderTemplate(templateType, userQuery, context, config) {
    ...
    shouldUseFallback(template, config) {
    ...
    buildPrompt(template, sanitizedQuery, context) {
        const sections = [];
        // System prompt
    ...
    selectOptimalModelSize(tokenCount, config) {
        const costBySize = {
    ...
    async estimateCost(templateType, userQuery, context, config) {
    ...
    detokenizeResponse(response, piiTokens) {
        return this.piiRedactor.detokenize(response, piiTokens);
    }
}
exports.PromptTemplateService = PromptTemplateService;
// Export singleton instance
let promptTemplateServiceInstance = null;
const getPromptTemplateService = (config) => {
...
exports.getPromptTemplateService = getPromptTemplateService;
